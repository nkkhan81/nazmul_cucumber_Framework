...
Feature: Login feature
  ...
  @login-sw
  Scenario: Verify webDriver switch to a different window and come back to root window
    When I click on Data Policy link on home screen
    And I switch the WebDriver to new window and verify page title
    And I click on Sign Up button on home screen
    And I close the current window and come back to the root window
